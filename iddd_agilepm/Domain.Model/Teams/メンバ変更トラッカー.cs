...
namespace SaaSOvation.AgilePM.Domain.Model.Teams
{
    ...
    public class メンバ変更トラッカー : ValueObject
    {
        internal メンバ変更トラッカー(DateTime enablingOn, DateTime nameChangedOn, DateTime emailAddressChangedOn)
        {
        ...
        public メンバ変更トラッカー EmailAddressChangedOn(DateTime asOfDateTime)
        {
            return new メンバ変更トラッカー(this.enablingOnDate, this.nameChangedOnDate, asOfDateTime);
        }

        public メンバ変更トラッカー EnablingOn(DateTime asOfDateTime)
        {
            return new メンバ変更トラッカー(asOfDateTime, this.nameChangedOnDate, this.emailAddressChangedOnDate);
        }

        public メンバ変更トラッカー NameChangedOn(DateTime asOfDateTime)
        {
            return new メンバ変更トラッカー(this.enablingOnDate, asOfDateTime, this.emailAddressChangedOnDate);
        }
