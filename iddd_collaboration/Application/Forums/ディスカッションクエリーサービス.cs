...
{
    public class ディスカッションクエリーサービス : AbstractQueryService
    {
        public ディスカッションクエリーサービス(string connectionString, string providerName)
            : base(connectionString, providerName)
        {
        }

        public IList<ディスカッションデータ> GetAllDiscussionsDataByForum(string tenantId, string forumId)
        {
            return QueryObjects<ディスカッションデータ>(
        ...
        public ディスカッションデータ GetDiscussionDataById(string tenantId, string discussionId)
        {
            return QueryObject<ディスカッションデータ>(
        ...
        public ディスカッションポストデータ GetDiscussionPostsDataById(string tenantId, string discussionId)
        {
            return QueryObject<ディスカッションポストデータ>(
                    "select "
