...
namespace SaaSOvation.IdentityAccess.Domain.Model
{
	...
	/// </summary>
	[CLSCompliant(true)]
	public static class ドメインレジストリ
	{
		/// <summary>
		/// Gets the instance of <see cref="I暗号化サービス"/> to use.
		/// </summary>
		public static I暗号化サービス EncryptionService
		{
			get
			{
				...
				return new Infrastructure.Services.MD5暗号化サービス();
			}
		}
		...
		/// </summary>
		public static パスワードサービス PasswordService
		{
			get { return new パスワードサービス(); }
		}
	}
}