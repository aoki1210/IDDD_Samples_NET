...
namespace SaaSOvation.IdentityAccess.Domain.Model.Identity
{
    ...
    public class 有効化
    {
        public static 有効化 IndefiniteEnablement()
        {
            return new 有効化(true, DateTime.MinValue, DateTime.MinValue);
        }

        public 有効化(bool enabled, DateTime startDate, DateTime endDate)
        {
        ...
        public override bool Equals(Object anotherObject)
        {
            ...
            {
                有効化 typedObject = (有効化)anotherObject;
                equalObjects =
