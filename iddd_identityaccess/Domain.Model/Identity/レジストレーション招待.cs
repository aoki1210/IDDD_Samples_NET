...
namespace SaaSOvation.IdentityAccess.Domain.Model.Identity
{
    ...
    public class レジストレーション招待
    {
        ...
        public レジストレーション招待 WillStartOn(DateTime date)
        {
        ...
        public レジストレーション招待 LastingUntil(DateTime date)
        {
        ...
        public override bool Equals(object anotherObject)
        {
            ...
            {
                var typedObject = (レジストレーション招待) anotherObject;
                equalObjects =
